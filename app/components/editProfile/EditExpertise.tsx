...
const EditExpertise = ({ data, onUpdate, updateClient }: Data) => {
  ...
  return (
    <div className={`${styles.editCKEditorModal} editExpertise`}>
      <div>
        {t("Expertise edit1")}
        <ul>
          <li>{t("Expertise edit2")}</li>
          <li>{t("Expertise edit3")}</li>
          <li> {t("Expertise edit4")}</li>
        </ul>
